...
%         warning('analyze filtered is hardcoded as "Off"')
        ...
        for iChan=1:length(fieldnames(getfield(app.Variables,variable)))
            ...
            for iWin=1:NumWindows
                ...
                app.Variables.Results=setfield(app.Variables.Results,stream,variable,channame,{iWin},'WindowName',getfield(app.Variables,variable,channame,'Windows',{iWin},'Name'));
                ...
                AreaPolarity=getfield(app.Variables,variable,channame,'Windows',{iWin},'AreaPolarity');
                app.Variables.Results=setfield(app.Variables.Results,stream,variable,channame,{iWin},'WindowExtents',WindowExtent);
