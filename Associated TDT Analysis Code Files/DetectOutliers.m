function [OutlierFlag,ExcludeChannel]=DetectOutliers(handles)
%Future versions of this code will output ApprovedTraces as
%linear-detrended data
data=handles.Variables.AllRaw;
...
si=handles.Variables.timepts(2)-handles.Variables.timepts(1);
tm=(1:size(data,4))*si;
pts=size(tm,2);
